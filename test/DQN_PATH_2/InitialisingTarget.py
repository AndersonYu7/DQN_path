...
black_area_width   = (imageSize[0]-real_pic_height/(real_pic_width/imageSize[0]))
start_pos_x = 0
end_pos_x = int(imageSize[1]-black_area_width)
ene_pos = end_pos_x*imageSize[0]+imageSize[1]-1
# totalImages = games * (imageSize[0] * imageSize[1] - black_area_width)
totalImages = games * (ene_pos+1)
# print(totalImages)
# breakpoint()
#====================
learningRate = 0.001
