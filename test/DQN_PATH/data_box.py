...
folderName = 'Images_yun_test_box'
...
def generate_random_blocks():
    ...
    return blocks
def assignBlocks(grid,xlimit,limit,numberOfBlocks,flag, now_game) :
    blocks = []
    if(now_game<int(totalGames/2)):
...
if __name__ == '__main__':
    ...
    for t in range(totalGames) :
        ...
        now_game = t
        assignBlocks(a,x,limit,numberOfBlocks,flag, now_game)
